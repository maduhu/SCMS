...
namespace System   
{
    public static class ObjectExtensions
    {
        ...
        public static void SetProperty(this object instance, string propertyName, object value)
        {
            ...
            if (pi == null)
                throw new SCMSException("No property '{0}' found on the instance of type '{1}'.", propertyName, instanceType);
            if (!pi.CanWrite)
                throw new SCMSException("The property '{0}' on the instance of type '{1}' does not have a setter.", propertyName, instanceType);
        ...
        public static object To(this object value, Type destinationType, CultureInfo culture)
        {
            if (value != null)
            {
                ...
                TypeConverter destinationConverter = destinationType.GetCustomTypeConverter();
                TypeConverter sourceConverter = sourceType.GetCustomTypeConverter();
