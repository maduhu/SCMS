...
TINY4.table=function(){
	function sorter4(n,t,p){this.n=n; this.id=t; this.p=p; if(this.p.init){this.init()}}
	sorter4.prototype.init=function(){
		...
		for(i;i<t.w;i++){
			...
			if(this.p.columns4){
				var l=this.p.columns4.length, x=0;
				for(x;x<l;x++){
					if(this.p.columns4[x].index==i){
						var g=this.p.columns4[x];
	...
	sorter4.prototype.reset=function(){
	...
	sorter4.prototype.sort=function(x,f,z){
	...
	sorter4.prototype.sethover=function(){
		if(this.p.hoverid){
	...
	sorter4.prototype.calc=function(){
	...
	sorter4.prototype.page=function(s){
	...
	sorter4.prototype.move=function(d,m){
		this.goto(d==1?(m?this.d:this.g+1):(m?1:this.g-1))
	};
	sorter4.prototype.goto=function(s){
		if(s<=this.d&&s>0){this.g=s; this.page((s-1)*this.p.size)}
	};
	sorter4.prototype.size=function(s){
		var t=this.t;
		if(s){this.p.size=s}
	...
	sorter4.prototype.showall=function(){
		this.size(this.t.t)
	};
	sorter4.prototype.search=function(f){
	...
	sorter4.prototype.hover=function(i,d){
		this.t.r[i].id=d?this.p.hoverid:''
	};
	sorter4.prototype.set=function(){
	...
	return{sorter4:sorter4}
}();

var sorter4;
function initSorter4() {        
        sorter4 = new TINY4.table.sorter4('sorter4','table4',{
		headclass:'head',
		ascclass:'asc',
		descclass:'desc',
		evenclass:'evenrow',
		...
		size:10,
		colddid:'columns4',
		currentid:'currentpage4',
		totalid:'totalpages4',
		startingrecid:'startrecord4',
		endingrecid:'endrecord4',
		totalrecid:'totalrecords4',
		hoverid:'selectedrow',
		...
		sum:[8],
		avg:[6,7,8,9],
		columns4:[{index:7, format:'%', decimals:1},{index:8, format:'$', decimals:0}],
		init:true
	});
    }
