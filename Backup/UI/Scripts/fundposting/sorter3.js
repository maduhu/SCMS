...
TINY3.table=function(){
	function sorter3(n,t,p){this.n=n; this.id=t; this.p=p; if(this.p.init){this.init()}}
	sorter3.prototype.init=function(){
		...
		for(i;i<t.w;i++){
			...
			if(this.p.columns3){
				var l=this.p.columns3.length, x=0;
				for(x;x<l;x++){
					if(this.p.columns3[x].index==i){
						var g=this.p.columns3[x];
	...
	sorter3.prototype.reset=function(){
	...
	sorter3.prototype.sort=function(x,f,z){
	...
	sorter3.prototype.sethover=function(){
		if(this.p.hoverid){
	...
	sorter3.prototype.calc=function(){
	...
	sorter3.prototype.page=function(s){
	...
	sorter3.prototype.move=function(d,m){
		this.goto(d==1?(m?this.d:this.g+1):(m?1:this.g-1))
	};
	sorter3.prototype.goto=function(s){
		if(s<=this.d&&s>0){this.g=s; this.page((s-1)*this.p.size)}
	};
	sorter3.prototype.size=function(s){
		var t=this.t;
		if(s){this.p.size=s}
	...
	sorter3.prototype.showall=function(){
		this.size(this.t.t)
	};
	sorter3.prototype.search=function(f){
	...
	sorter3.prototype.hover=function(i,d){
		this.t.r[i].id=d?this.p.hoverid:''
	};
	sorter3.prototype.set=function(){
	...
	return{sorter3:sorter3}
}();

var sorter3;
function initSorter3() {        
        sorter3 = new TINY3.table.sorter3('sorter3','table3',{
		headclass:'head',
		ascclass:'asc',
		descclass:'desc',
		evenclass:'evenrow',
		...
		sum:[8],
		avg:[6,7,8,9],
		columns3:[{index:7, format:'%', decimals:1},{index:8, format:'$', decimals:0}],
		init:true
	});
    }
