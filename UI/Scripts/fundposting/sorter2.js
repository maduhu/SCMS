...
TINY2.table=function(){
	function sorter2(n,t,p){this.n=n; this.id=t; this.p=p; if(this.p.init){this.init()}}
	sorter2.prototype.init=function(){
		...
		for(i;i<t.w;i++){
			...
			if(this.p.columns2){
				var l=this.p.columns2.length, x=0;
				for(x;x<l;x++){
					if(this.p.columns2[x].index==i){
						var g=this.p.columns2[x];
	...
	sorter2.prototype.reset=function(){
	...
	sorter2.prototype.sort=function(x,f,z){
	...
	sorter2.prototype.sethover=function(){
		if(this.p.hoverid){
	...
	sorter2.prototype.calc=function(){
	...
	sorter2.prototype.page=function(s){
	...
	sorter2.prototype.move=function(d,m){
		this.goto(d==1?(m?this.d:this.g+1):(m?1:this.g-1))
	};
	sorter2.prototype.goto=function(s){
		if(s<=this.d&&s>0){this.g=s; this.page((s-1)*this.p.size)}
	};
	sorter2.prototype.size=function(s){
		var t=this.t;
		if(s){this.p.size=s}
	...
	sorter2.prototype.showall=function(){
		this.size(this.t.t)
	};
	sorter2.prototype.search=function(f){
	...
	sorter2.prototype.hover=function(i,d){
		this.t.r[i].id=d?this.p.hoverid:''
	};
	sorter2.prototype.set=function(){
...
var sorter2;
function initSorter2() {        
        sorter2 = new TINY2.table.sorter2('sorter2','table2',{
		headclass:'head',
		ascclass:'asc',
		descclass:'desc',
		evenclass:'evenrow',
		...
		sum:[8],
		avg:[6,7,8,9],
		columns2:[{index:7, format:'%', decimals:1},{index:8, format:'$', decimals:0}],
		init:true
	});
    }
