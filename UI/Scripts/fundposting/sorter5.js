...
TINY5.table = function () {
    function sorter5(n, t, p) { this.n = n; this.id = t; this.p = p; if (this.p.init) { this.init() } }
    sorter5.prototype.init = function () {
        ...
        for (i; i < t.w; i++) {
            ...
            if (this.p.columns5) {
                var l = this.p.columns5.length, x = 0;
                for (x; x < l; x++) {
                    if (this.p.columns5[x].index == i) {
                        var g = this.p.columns5[x];
    ...
    sorter5.prototype.reset = function () {
    ...
    sorter5.prototype.sort = function (x, f, z) {
    ...
    sorter5.prototype.sethover = function () {
        if (this.p.hoverid) {
    ...
    sorter5.prototype.calc = function () {
    ...
    sorter5.prototype.page = function (s) {
    ...
    sorter5.prototype.move = function (d, m) {
        this.goto(d == 1 ? (m ? this.d : this.g + 1) : (m ? 1 : this.g - 1))
    };
    sorter5.prototype.goto = function (s) {
        if (s <= this.d && s > 0) { this.g = s; this.page((s - 1) * this.p.size) }
    };
    sorter5.prototype.size = function (s) {
        var t = this.t;
        if (s) { this.p.size = s }
    ...
    sorter5.prototype.showall = function () {
        this.size(this.t.t)
    };
    sorter5.prototype.search = function (f) {
    ...
    sorter5.prototype.hover = function (i, d) {
        this.t.r[i].id = d ? this.p.hoverid : ''
    };
    sorter5.prototype.set = function () {
    ...
    return { sorter5: sorter5 }
} ();

var sorter5;
function initSorter5() {
    sorter5 = new TINY5.table.sorter5('sorter5', 'table5', {
        headclass: 'head',
        ascclass: 'asc',
        descclass: 'desc',
        evenclass: 'evenrow',
        ...
        size: 10,
        colddid: 'columns5',
        currentid: 'currentpage5',
        totalid: 'totalpages5',
        startingrecid: 'startrecord5',
        endingrecid: 'endrecord5',
        totalrecid: 'totalrecords5',
        hoverid: 'selectedrow',
        ...
        sum: [8],
        avg: [6, 7, 8, 9],
        columns5: [{ index: 7, format: '%', decimals: 1 }, { index: 8, format: '$', decimals: 0}],
        init: true
    });
}
